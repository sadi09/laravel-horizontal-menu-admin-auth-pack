                                ...
                                <ul class="nav nav-tabs tab-no-active-fill" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active ps-2 pe-2" id="revenue-for-last-month-tab"
                                           ...
                                           aria-controls="revenue-for-last-month" aria-selected="true">Revenue
                                            for last month</a>
                                    </li>
                                    <li class="nav-item">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link ps-2 pe-2" id="data-managed-tab" data-bs-toggle="tab"
                                           ...
                                           aria-selected="false">Data managed</a>
                                    </li>
                                    <li class="nav-item">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <div class="d-lg-flex align-items-center justify-content-between">
                                        ...
                                        <div class="mb-3">
                                            <button type="button"
                                                    class="btn btn-outline-light text-dark font-weight-normal">
                                                Day
                                            </button>
                                            <button type="button"
                                                    class="btn btn-outline-light text-dark font-weight-normal">
